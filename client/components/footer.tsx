...
import { Github, Linkedin, Mail, Twitter, MapPin, ArrowRight, Download } from "lucide-react"
...
export function Footer({ footerData }: FooterProps) {
  ...
  return (
    <footer id="contact" className="py-32 px-4 bg-zinc-50 dark:bg-black bg-dot-grid border-t border-zinc-200 dark:border-zinc-800 transition-colors duration-500 relative overflow-hidden">
