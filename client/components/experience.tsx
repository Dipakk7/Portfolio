...
export function Experience({ experiences }: ExperienceProps) {
    ...
    return (
        <section id="experience" className="py-32 px-4 bg-white dark:bg-black bg-dot-grid relative overflow-hidden">
                            ...
                            >
                                ...
                                <div className={`ml-20 md:ml-0 md:w-[calc(50%-2rem)] ${index % 2 === 0 ? "md:pr-12" : "md:pl-12"}`}>
                                    <motion.div
                                        ...
                                        className="relative overflow-hidden rounded-2xl p-8 border border-zinc-200 dark:border-zinc-900/60 bg-white/50 dark:bg-zinc-950/40 backdrop-blur-xl group"
                                    >
                                        {/* Glowing Effect */}
                                        <GlowingEffect
                                            spread={40}
